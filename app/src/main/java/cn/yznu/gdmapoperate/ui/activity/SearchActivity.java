...
public class SearchActivity extends AppCompatActivity implements LocationSource, AMapLocationListener {
    ...
    private TextView tvBottom; //BottomSheet收起时显示
    ...
    private void initView(@Nullable Bundle savedInstanceState) {
        tvBottom = findViewById(R.id.tv_bottom_tip);
        ...
        behavior.setBottomSheetCallback(new BottomSheetBehavior.BottomSheetCallback() {
            ...
            public void onStateChanged(@NonNull View bottomSheet, @BottomSheetBehavior.State int newState) {
                String state = "null";
                tvBottom.setVisibility(View.GONE);  //默认隐藏状态， 只有在BottomSheet隐藏时显示
                switch (newState) {
                    case 1:
                ...
                Log.d("BottomSheetDemo", "state:" + state);

            }

            @Override
            public void onSlide(@NonNull final View bottomSheet, final float slideOffset) {
                Log.d("BottomSheetDemo", "slideOffset:" + slideOffset + ", state:"
                     + behavior.getState());
